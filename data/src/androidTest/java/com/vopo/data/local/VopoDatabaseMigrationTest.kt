...
class VopoDatabaseMigrationTest {

    private val testDbName = "vopo-migration-test"
    ...
    fun migrate1To42_fullChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("vopo-full-chain-test", 1).close()

        migrationTestHelper.runMigrationsAndValidate(
            "vopo-full-chain-test",
            42,
            true,
    ...
    fun migrate44To51_publicMasterUpgradeValidatesLatestSchema() {
        migrationTestHelper.createDatabase("vopo-public-master-44-51-test", 44).apply {
            execSQL(
                """
    ...
    fun migrate48To49_addsProviderHttpProfileColumns() {
        migrationTestHelper.createDatabase("vopo-48-49-test", 48).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate49To50_createsXtreamLiveOnboardingStateTable() {
        migrationTestHelper.createDatabase("vopo-49-50-test", 49).close()
    ...
    fun migrate50To51_addsXtreamLiveOnboardingProfileDiagnostics() {
        migrationTestHelper.createDatabase("vopo-50-51-test", 50).close()
    ...
    fun migrate51To52_addsXtreamLiveSyncMode() {
        migrationTestHelper.createDatabase("vopo-51-52-test", 51).close()
    ...
    fun migrate52To53_addsStalkerHardeningHydrationColumns() {
        migrationTestHelper.createDatabase("vopo-52-53-test", 52).close()
    ...
    fun migrate53To54_addsStalkerIdentityColumns() {
        migrationTestHelper.createDatabase("vopo-53-54-test", 53).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate40To41_addsAudioVideoOffsetColumn() {
        migrationTestHelper.createDatabase("vopo-40-41-test", 40).close()
    ...
    fun migrate41To42_createsPlaybackCompatibilityRecordsTable() {
        migrationTestHelper.createDatabase("vopo-41-42-test", 41).close()
    ...
    fun migrate42To43_addsProviderSeriesIdColumn() {
        migrationTestHelper.createDatabase("vopo-42-43-test", 42).close()
    ...
    fun migrate43To44_addsPagedVodHydrationColumns() {
        migrationTestHelper.createDatabase("vopo-43-44-test", 43).close()
    ...
    fun migrate38To39_addsStalkerProviderColumnsAndUniqueIndex() {
        migrationTestHelper.createDatabase("vopo-38-39-test", 38).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate32To33_backfillsMovieWatchCountAndAddsGlobalFavoritesIndex() {
        migrationTestHelper.createDatabase("vopo-32-33-test", 32).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate33To34_addsSuccessTimestampsAndProgramsEndTimeIndex() {
        migrationTestHelper.createDatabase("vopo-33-34-test", 33).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate44To45_dedupesGlobalFavoritesAndAddsNullSafeUniqueKey() {
        migrationTestHelper.createDatabase("vopo-44-45-test", 44).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate45To46_rebuildsSeriesStageWithProviderSeriesKey() {
        migrationTestHelper.createDatabase("vopo-45-46-test", 45).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate46To47_createsBrowseQueryIndexes() {
        migrationTestHelper.createDatabase("vopo-46-47-test", 46).close()
    ...
    fun migrate47To48_createsXtreamIndexBackfillsRowsAndMarksSummaryState() {
        migrationTestHelper.createDatabase("vopo-47-48-test", 47).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate34To35_createsSearchHistoryTable() {
        migrationTestHelper.createDatabase("vopo-34-35-test", 34).close()
    ...
    fun migrate31To32_scopesFavoritesAndSplitsMixedProviderGroups() {
        migrationTestHelper.createDatabase("vopo-31-32-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate31To32_assignsLegacyGroupsWhenNoProviderIsActive() {
        migrationTestHelper.createDatabase("vopo-31-32-no-active-test", 31).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate35To36_addsProgramRemindersAndEpgMatchMetadata() {
        migrationTestHelper.createDatabase("vopo-35-36-test", 35).close()
    ...
    fun migrate36To37_createsTmdbIdentityTable() {
        migrationTestHelper.createDatabase("vopo-36-37-test", 36).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate14To15_addsAuditCompletionColumns() {
        migrationTestHelper.createDatabase("vopo-14-15-test", 14).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate59To60_addsDownloadSourceColumns() {
        migrationTestHelper.createDatabase("vopo-59-60-test", 59).close()
    ...
    fun migrate57To61_upgradeChainValidatesLatestSchema() {
        migrationTestHelper.createDatabase("vopo-57-61-test", 57).close()
    ...
    fun migrate60To61_release114To115UpgradePreservesProviders() {
        migrationTestHelper.createDatabase("vopo-release-114-115-test", 60).apply {
            execSQL(
                """
                INSERT INTO providers (
                    id, name, type, server_url, username, password, m3u_url, epg_url,
    ...
    fun migrate60To61_addsStalkerAdvancedOptionsJson() {
        migrationTestHelper.createDatabase("vopo-60-61-test", 60).close()
