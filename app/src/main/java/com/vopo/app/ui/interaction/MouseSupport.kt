package com.vopo.app.ui.interaction
...
fun Modifier.mouseClickable(
    ...
    if (!isTv) {
        if (!enabled) {
            ...
            // Phone / tablet path with gesture support.
            // Using detectTapGestures allows parent scrollables to intercept touch correctly.
