...
import com.vopo.app.diagnostics.RuntimeDiagnosticsManager
import com.vopo.app.update.GitHubReleaseChecker
import com.vopo.app.ui.accessibility.isReducedMotionEnabled
...
import com.vopo.player.timeshift.TimeshiftDiskManager
import javax.inject.Inject
import okhttp3.OkHttpClient

@HiltAndroidApp
class VopoApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        val gcWorkRequest = PeriodicWorkRequestBuilder<com.vopo.data.sync.SyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)
