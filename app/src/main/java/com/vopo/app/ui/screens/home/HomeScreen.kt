...
import com.vopo.app.ui.components.LiveSourceSwitcher
import com.vopo.app.ui.components.shell.ContentMetadataStrip
import com.vopo.app.ui.components.shell.LiveChannelRowSurface
import com.vopo.app.ui.components.shell.StatusPill
import com.vopo.app.ui.components.TvEmptyState
import com.vopo.app.ui.components.dialogs.CategoryOptionsDialog
import com.vopo.app.ui.components.dialogs.HiddenCategoriesDialog
import com.vopo.app.ui.components.dialogs.HiddenChannelsDialog
import com.vopo.app.ui.components.dialogs.PinDialog
import com.vopo.app.ui.components.dialogs.PremiumDialog
import com.vopo.app.ui.components.dialogs.PremiumDialogActionButton
import com.vopo.app.ui.components.dialogs.PremiumDialogFooterButton
...
import com.vopo.app.ui.remote.LiveBrowseRemoteShortcutHandler
import com.vopo.app.ui.remote.dispatchLiveBrowseRemoteShortcut
import com.vopo.app.ui.remote.remoteColorButtonForKeyCode
import com.vopo.domain.model.RemoteShortcutProfile
                            ...
                            val handler = when (val target = focusedRemoteShortcutTarget) {
                                ...
                                is FocusedRemoteShortcutTarget.CategoryTarget -> {
                                    ...
                                    if (isLockedCategory && action in setOf(
                                            com.vopo.domain.model.RemoteShortcutAction.PIN_CATEGORY,
                                            com.vopo.domain.model.RemoteShortcutAction.HIDE_CATEGORY
                                        )
                                    ) {
                                        null
                                    } else {
