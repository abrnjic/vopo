...
class StalkerProviderTest {
    ...
    fun buildCatchUpUrls_returns_internal_archive_candidates_for_live_token() = runTest {
        val provider = StalkerProvider(
            ...
            portalUrl = "https://portal.example.com/c/",
            macAddress = "00:1A:79:12:34:56",
            playbackBackendHint = com.vopo.domain.model.StalkerPlaybackBackendHint.PLAY_LIVE,
            deviceProfile = "MAG250",
            timezone = "UTC",
            locale = "en"
        )
    ...
    fun resolvePlaybackInfo_omits_authorization_for_play_live_temp_links() = runTest {
        val provider = StalkerProvider(
            ...
            portalUrl = "https://portal.example.com/c/",
            macAddress = "00:1A:79:12:34:56",
            playbackBackendHint = com.vopo.domain.model.StalkerPlaybackBackendHint.TEMP_LINK_STRICT,
            cookieModeHint = com.vopo.domain.model.StalkerCookieMode.CREATE_LINK,
        ...
        assertThat(success.data.cookieMode).isNotEqualTo(com.vopo.domain.model.StalkerCookieMode.NONE)
    }
    ...
    fun authenticate_persists_effective_learned_mag_identity() = runTest {
        val provider = StalkerProvider(
            ...
            api = FakeStalkerApiService(
                profile = StalkerProviderProfile(
                    accountName = "Room",
                    effectiveAuthMode = com.vopo.domain.model.StalkerAuthMode.MAC_ONLY,
                    portalProfile = com.vopo.domain.model.StalkerPortalProfile.MODULE_GATED,
                    portalFingerprint = com.vopo.domain.model.StalkerPortalFingerprint.MODULE_GATED,
                    magPreset = com.vopo.domain.model.StalkerMagPreset.MINISTRA_MODERN,
                    bootstrapRecipe = com.vopo.domain.model.StalkerBootstrapRecipe.MODULE_GATED,
                    fingerprintEvidence = StalkerFingerprintEvidence(
                        endpointPreference = com.vopo.domain.model.StalkerEndpointPreference.PORTAL,
                        cookieMode = com.vopo.domain.model.StalkerCookieMode.BOTH,
                        playbackBackendHint = com.vopo.domain.model.StalkerPlaybackBackendHint.TEMP_LINK_STRICT
                    )
                )
            ),
        ...
        assertThat(result).isInstanceOf(Result.Success::class.java)
        val success = result as Result.Success
        assertThat(success.data.stalkerMagPreset).isEqualTo(com.vopo.domain.model.StalkerMagPreset.MINISTRA_MODERN)
