package com.vopo.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.vopo.data.local.entity.*
import com.vopo.data.remote.stalker.StalkerPlaybackDescriptor
...
fun CategoryEntity.toDomain() = com.vopo.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun com.vopo.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { com.vopo.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(com.vopo.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = com.vopo.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.vopo.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun com.vopo.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    com.vopo.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun com.vopo.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = com.vopo.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = com.vopo.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { com.vopo.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(com.vopo.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { com.vopo.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun com.vopo.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
