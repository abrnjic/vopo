...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): com.vopo.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is com.vopo.domain.model.Result.Success -> Result.success()
            is com.vopo.domain.model.Result.Error -> Result.retry()
            com.vopo.domain.model.Result.Loading -> Result.retry()
        }
    }
