...
import com.vopo.player.PLAYER_TRACK_AUTO_ID
import com.vopo.player.PlayerEngine
import com.vopo.player.PlayerError
import com.vopo.player.PlayerRenderSurfaceType
import com.vopo.player.PlayerSurfaceResizeMode
import com.vopo.player.PlayerTrack
import com.vopo.player.TrackType
...
import com.vopo.app.ui.components.dialogs.ProgramHistoryDialog
import androidx.compose.ui.res.stringResource
import androidx.lifecycle.Lifecycle
import com.vopo.app.R
import com.vopo.app.MainActivity
import com.vopo.app.cast.CastConnectionState
import com.vopo.app.ui.components.PlayerRenderView
import com.vopo.app.ui.design.requestFocusSafely
import com.vopo.app.ui.notifications.rememberNotificationPermissionGate
import com.vopo.app.ui.screens.player.overlay.ChannelInfoOverlay
import com.vopo.app.ui.screens.player.overlay.ChannelVariantSelectionDialog
import com.vopo.app.ui.screens.player.overlay.CategoryListOverlay
import com.vopo.app.ui.screens.player.overlay.ChannelListOverlay
import com.vopo.app.ui.screens.player.overlay.DiagnosticsOverlay
import com.vopo.app.ui.screens.player.overlay.EpgOverlay
import com.vopo.app.ui.screens.player.overlay.PlayerErrorOverlay
import com.vopo.app.ui.screens.player.overlay.PlayerNoticeBanner
import com.vopo.app.ui.screens.player.overlay.PlayerEpisodeSelectionDialog
import com.vopo.app.ui.screens.player.overlay.PlayerResumePrompt
import com.vopo.app.ui.screens.player.overlay.PlayerTrackSelectionDialog
import com.vopo.app.ui.screens.player.overlay.PlayerAspectRatioToast
import com.vopo.app.ui.screens.player.overlay.PlayerControlsOverlay
import com.vopo.app.ui.screens.player.overlay.PlayerNumericInputOverlay
import com.vopo.app.ui.screens.player.overlay.PlayerResolutionBadge
import com.vopo.app.ui.screens.player.overlay.PlayerAudioVideoOffsetDialog
import com.vopo.app.ui.screens.player.overlay.PlayerSpeedSelectionDialog
import com.vopo.app.ui.screens.player.overlay.PlayerSleepTimerDialog
import com.vopo.app.ui.screens.player.overlay.PlayerSleepTimerWarningOverlay
import com.vopo.app.ui.screens.player.overlay.NextEpisodeCountdownOverlay
import com.vopo.app.ui.screens.multiview.MultiViewViewModel
import com.vopo.app.ui.screens.multiview.MultiViewPlannerDialog
...
fun PlayerScreen(
    ...
    Box(
        ...
        if (currentChannelRecording?.status == com.vopo.domain.model.RecordingStatus.RECORDING) {
...
private fun PlayerControlsOverlayHost(
    ...
    currentRecordingStatus: com.vopo.domain.model.RecordingStatus?,
    isMuted: Boolean,
    playbackSpeed: Float,
    mediaTitle: String?,
    sleepTimerUiState: SleepTimerUiState,
