...
import com.vopo.data.sync.ContentCachePolicy
import com.vopo.data.sync.SyncManager
import com.vopo.data.util.MoviePresentationSettings
import com.vopo.data.util.buildPresentedMovies
import com.vopo.data.util.rankSearchResults
import com.vopo.data.util.toFtsPrefixQuery
...
import com.vopo.domain.model.VodMovieVariant
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private suspend fun loadPresentationCandidates(movie: Movie): List<com.vopo.data.local.entity.MovieEntity> {
    ...
    private fun com.vopo.data.local.entity.MovieEntity.hasFreshXtreamDetails(now: Long = System.currentTimeMillis()): Boolean {
