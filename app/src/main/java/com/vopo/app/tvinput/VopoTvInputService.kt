...
@AndroidEntryPoint
class VopoTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = VopoSession(this)

    private inner class VopoSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "VopoTvInput"
        const val DEFAULT_USER_AGENT = "VopoTvInput"
