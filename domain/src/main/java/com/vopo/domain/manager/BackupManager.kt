...
data class BackupData(
    ...
    val favorites: List<com.vopo.domain.model.Favorite>? = null,
    val virtualGroups: List<com.vopo.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): com.vopo.domain.model.Result<Unit>
