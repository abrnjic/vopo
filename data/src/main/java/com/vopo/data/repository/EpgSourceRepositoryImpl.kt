...
import com.vopo.data.epg.EpgNameNormalizer
...
import com.vopo.domain.model.EpgSource
import com.vopo.domain.model.Program
import com.vopo.domain.model.ProviderEpgSourceAssignment
        ...
        transactionRunner.inTransaction {
            ...
            epgSourceDao.insert(
                EpgSourceEntity(
                    ...
                    url = "vopo://epg-source-staging/${source.id}",
                    enabled = false,
