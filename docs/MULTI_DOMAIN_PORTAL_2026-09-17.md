...
Ovaj dodatni popravak još nije objavljen. Automatska provjera odobrenja odbila je ponovno otvaranje Vercel kartice zbog prethodne zabrane pristupa, pa nisu provjereni novi privatni logovi niti pokrenuta dodatna objava. Za nastavak kroz Vercel potreban je izričit korisnički pristanak na taj pristup i objavu. Lokalni dokaz: /private/tmp/vopo-domains-bundled-build.log.
