...
import com.vopo.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import com.vopo.data.remote.stalker.StalkerPlaybackResolutionException
...
import com.vopo.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is com.vopo.domain.model.Result.Success -> resolvedResult.data
                    is com.vopo.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = com.vopo.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: com.vopo.data.remote.stalker.StalkerPlaybackInfo
    ) {
