...
import com.vopo.domain.model.RemoteShortcutAction
...
internal fun encodeRemoteShortcutSelection(
    ...
    return when (normalized.mode) {
        com.vopo.domain.model.RemoteShortcutSelectionMode.PROFILE_DEFAULT -> null
        com.vopo.domain.model.RemoteShortcutSelectionMode.GLOBAL_DEFAULT -> REMOTE_SHORTCUT_USE_GLOBAL_SENTINEL
        com.vopo.domain.model.RemoteShortcutSelectionMode.ACTION -> normalized.action?.storageValue
    }
}
