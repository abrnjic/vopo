...
class OkHttpStalkerApiServiceTest {
    ...
    fun authenticate_module_gated_recipe_rebuilds_profile_for_modern_mag_preset() = runTest {
        ...
        val result = service.authenticate(
            buildStalkerDeviceProfile(
                ...
                portalFingerprintHint = com.vopo.domain.model.StalkerPortalFingerprint.MODULE_GATED,
                deviceProfile = "MAG250",
                timezone = "UTC",
                locale = "en"
            )
    ...
    fun buildStalkerDeviceProfile_sanitizes_impossible_auth_mode_hints() {
        val credentialsOnly = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "",
            authMode = com.vopo.domain.model.StalkerAuthMode.MAC_PLUS_CREDENTIALS,
            username = "alice",
            password = "secret",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        val macOnly = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "00:1A:79:12:34:56",
            authMode = com.vopo.domain.model.StalkerAuthMode.CREDENTIALS_ONLY,
            username = "",
            password = "",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        val strictProfile = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "00:1A:79:12:34:56",
            authMode = com.vopo.domain.model.StalkerAuthMode.MAC_ONLY,
            magPresetHint = com.vopo.domain.model.StalkerMagPreset.MAG254_STRICT,
            username = "",
            password = "",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        assertThat(credentialsOnly.authMode).isEqualTo(com.vopo.domain.model.StalkerAuthMode.CREDENTIALS_ONLY)
        assertThat(macOnly.authMode).isEqualTo(com.vopo.domain.model.StalkerAuthMode.MAC_ONLY)
