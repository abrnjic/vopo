...
internal fun observeSettingsPreferenceSnapshot(
    ...
    return combine(
        ...
        SettingsPreferenceSnapshot(
            ...
            playerSurfaceMode = com.vopo.domain.model.PlayerSurfaceMode.AUTO,
            ...
            remoteShortcutPreferences = com.vopo.domain.model.RemoteShortcutPreferences(),
    ...
    }.combine(preferencesRepository.cachedAppUpdateSha256) { snapshot, sha256 ->
        snapshot.copy(cachedAppUpdateSha256 = sha256)
