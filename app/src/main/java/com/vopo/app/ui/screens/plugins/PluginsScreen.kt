...
import com.vopo.app.plugins.InstalledVopoPlugin
import com.vopo.app.plugins.PluginConfigurationAction
import com.vopo.app.plugins.PluginConfigurationField
import com.vopo.app.plugins.PluginConfigurationSection
            ...
            if (configuration != null) {
                ...
                LazyColumn(
                    ...
                    if (uiState.plugins.isEmpty() && !uiState.isLoading) {
                        item {
                            Text(
                                text = "No compatible Vopo plugins are installed.",
...
private fun PluginInstallPanel(
    ...
    Column(
        ...
        Text(
            text = "Manual installs are detected when this screen refreshes. Compatible plugins expose the Vopo plugin service.",
            style = MaterialTheme.typography.bodySmall,
...
private fun PluginInstallUrlDialog(
    ...
    PremiumDialog(
        ...
        subtitle = "Enter the direct APK URL. Vopo will download it and open the installer.",
        onDismissRequest = {
            keyboardController?.hide()
