...
object VopoPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "com.vopo.plugin.API"
    const val META_MANIFEST_JSON = "com.vopo.plugin.MANIFEST_JSON"
    const val META_ID = "com.vopo.plugin.ID"
    const val META_NAME = "com.vopo.plugin.NAME"
    const val META_VERSION_NAME = "com.vopo.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "com.vopo.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "com.vopo.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "com.vopo.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "com.vopo.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "com.vopo.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "com.vopo.plugin.PROVIDER_NAME"
