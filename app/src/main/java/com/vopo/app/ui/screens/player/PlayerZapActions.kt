    ...
    viewModelScope.launch {
        withScopedScrubbingMode(playerEngine::setScrubbingMode) {
            ...
            playerEngine.playbackState
                .filter {
                    it == com.vopo.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: com.vopo.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): com.vopo.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): com.vopo.domain.model.Channel? {
...
internal fun PlayerViewModel.resolveChannelNumber(
    channel: com.vopo.domain.model.Channel,
    index: Int
