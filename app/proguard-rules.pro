...
-keepclassmembers class com.vopo.data.remote.** { <fields>; }
...
-keep class com.vopo.domain.model.** { *; }
-keep class com.vopo.data.local.entity.** { *; }
-keep class com.vopo.data.remote.xtream.model.** { *; }

# ── Security / TLS ──────────────────────────────────────────
-keepnames class com.vopo.data.security.CredentialCrypto
-keepclassmembers class com.vopo.data.security.CredentialCrypto {
    <fields>;
    <methods>;
}
