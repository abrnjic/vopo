...
import com.vopo.data.remote.http.DefaultUserAgentInterceptor
import com.vopo.data.remote.http.buildAppRequestProfile
import com.vopo.data.remote.http.buildAppUserAgent
import com.vopo.data.remote.stalker.OkHttpStalkerApiService
...
object NetworkModule {
    ...
    fun provideOkHttpClient(
        ...
        return OkHttpClient.Builder()
            .cache(
                Cache(
                    directory = File(context.cacheDir, "vopo_http_cache"),
    ...
    fun provideMainPlayerEngine(
        ...
        playbackCompatibilityRepository: com.vopo.domain.repository.PlaybackCompatibilityRepository,
