...
bound service with the action `com.vopo.plugin.API` and talks to them
...
```xml
<action android:name="com.vopo.plugin.API" />
```
...
reads `com.vopo.plugin.MANIFEST_JSON` service metadata, then individual
...
```xml
<meta-data android:name="com.vopo.plugin.ID" android:value="com.example.plugin" />
<meta-data android:name="com.vopo.plugin.NAME" android:value="Example Plugin" />
<meta-data android:name="com.vopo.plugin.VERSION_NAME" android:value="1.0.0" />
<meta-data android:name="com.vopo.plugin.VERSION_CODE" android:value="1" />
<meta-data android:name="com.vopo.plugin.DESCRIPTION" android:value="Adds external capabilities to StreamVault." />
<meta-data android:name="com.vopo.plugin.PROVIDER_NAME" android:value="Example Provider" />
<meta-data android:name="com.vopo.plugin.CONFIGURATION_MODE" android:value="host.schema" />
<meta-data android:name="com.vopo.plugin.CONFIGURATION_ACTIVITY_ACTION" android:value="" />
<meta-data android:name="com.vopo.plugin.CAPABILITIES" android:value="provider.m3u,playback.prepare,cast.rewriteUrl,configuration.schema" />
```
...
- Expose exactly one `com.vopo.plugin.API` service.
