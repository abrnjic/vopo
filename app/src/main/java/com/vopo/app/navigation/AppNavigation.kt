...
import com.vopo.app.ui.screens.dashboard.DashboardScreen
import com.vopo.app.ui.screens.multiview.MultiViewScreen
import com.vopo.app.ui.screens.home.HomeScreen
import com.vopo.app.ui.screens.movies.MoviesScreen
import com.vopo.app.ui.screens.player.PlayerScreen
import com.vopo.app.ui.screens.plugins.PluginsScreen
import com.vopo.app.ui.screens.provider.ProviderSetupScreen
import com.vopo.app.ui.screens.series.SeriesScreen
import com.vopo.app.ui.screens.settings.SettingsScreen
import com.vopo.app.ui.screens.welcome.WelcomeScreen
import com.vopo.app.ui.screens.downloads.DownloadsScreen
            ...
            DashboardScreen(
                ...
                onRecentChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.vopo.domain.model.VirtualCategoryIds.RECENT,
                ...
                onFavoriteChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.vopo.domain.model.VirtualCategoryIds.FAVORITES,
                            providerId = channel.providerId,
                            isVirtual = true,
                            combinedProfileId = combinedProfileId,
                            returnRoute = Routes.HOME
                ...
                onPlaybackHistoryClick = { history ->
                    val route = when (history.contentType) {
                        com.vopo.domain.model.ContentType.LIVE -> {
                            Routes.player(
                        ...
                        com.vopo.domain.model.ContentType.MOVIE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
                        ...
                        com.vopo.domain.model.ContentType.SERIES -> {
                            Routes.seriesDetail(history.contentId, Routes.HOME)
                        }
                        com.vopo.domain.model.ContentType.SERIES_EPISODE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
...
// ... (rest of file)
        ...
        composable(
            ...
            com.vopo.app.ui.screens.epg.FullEpgScreen(
        ...
        composable(
            ...
            com.vopo.app.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            com.vopo.app.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            com.vopo.app.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            com.vopo.app.ui.screens.series.SeriesDetailScreen(
