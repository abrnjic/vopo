...
import com.vopo.app.diagnostics.CrashReportStore
...
import com.vopo.app.update.AppUpdateDownloadState
import com.vopo.app.update.AppUpdateDownloadStatus
...
import com.vopo.data.sync.SyncRepairSection
...
import com.vopo.domain.model.LiveStreamFormatMode
...
import com.vopo.domain.model.RecordingStorageConfig
import com.vopo.domain.model.RecordingStorageState
import com.vopo.domain.model.RemoteColorButton
import com.vopo.domain.model.RemoteShortcutProfile
import com.vopo.domain.model.RemoteShortcutSelection
...
import com.vopo.domain.usecase.ExportBackupResult
import com.vopo.domain.usecase.ImportBackup
import com.vopo.domain.usecase.ImportBackupCommand
import com.vopo.domain.usecase.ImportBackupResult
...
import com.vopo.domain.usecase.SyncProviderCommand
import com.vopo.domain.usecase.SyncProviderResult
...
class SettingsViewModel @Inject constructor(
    ...
    private val playbackHistoryRepository: com.vopo.domain.repository.PlaybackHistoryRepository,
    ...
    private val epgSourceRepository: com.vopo.domain.repository.EpgSourceRepository,
    ...
    private fun com.vopo.app.diagnostics.CrashReportSummary.toUiModel(): CrashReportUiModel =
        CrashReportUiModel(
            timestamp = timestamp,
            exception = exception,
            fileName = fileName,
    ...
    fun setPlayerSurfaceMode(mode: com.vopo.domain.model.PlayerSurfaceMode) {
        viewModelScope.launch {
