...
import com.vopo.app.util.OfficialBuildStatus
...
private fun formatExternalPlaybackModeLabel(
    mode: com.vopo.domain.model.ExternalPlaybackMode,
    context: Context
): String = when (mode) {
    com.vopo.domain.model.ExternalPlaybackMode.INTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_internal)
    com.vopo.domain.model.ExternalPlaybackMode.ASK_EVERY_TIME -> context.getString(R.string.settings_external_playback_mode_external)
    com.vopo.domain.model.ExternalPlaybackMode.EXTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_external)
}
