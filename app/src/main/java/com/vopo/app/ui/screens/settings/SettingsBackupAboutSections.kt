...
internal fun LazyListScope.settingsAboutSection(
    ...
    item {
        ...
        LaunchedEffect(downloadStatus) {
            if (downloadStatus == com.vopo.app.update.AppUpdateDownloadStatus.Downloading) {
                while (true) {
        ...
        if (shouldShowUpdateDownloadAction(uiState.appUpdate)) {
            ClickableSettingsRow(
                ...
                onClick = {
                    if (uiState.appUpdate.downloadStatus == com.vopo.app.update.AppUpdateDownloadStatus.Downloaded) {
                        onInstallDownloadedUpdate()
                    } else if (uiState.appUpdate.downloadStatus != com.vopo.app.update.AppUpdateDownloadStatus.Downloading) {
